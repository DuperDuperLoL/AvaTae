...
struct ConfigLoader {
    ...
    int SENSE_ENEMY_VISIBLE_BORDER_STYLE = 6;
    int SENSE_ENEMY_VISIBLE_BORDER_WIDTH = 32;

    float SENSE_ENEMY_INVISIBLE_COLOR_RED = 3;
    ...
    int SENSE_ENEMY_INVISIBLE_BORDER_STYLE = 6;
    int SENSE_ENEMY_INVISIBLE_BORDER_WIDTH = 32;

    float SENSE_ENEMY_LOCKEDON_COLOR_RED = 3;
    float SENSE_ENEMY_LOCKEDON_COLOR_GREEN = 0;
    float SENSE_ENEMY_LOCKEDON_COLOR_BLUE = 0;
    int SENSE_ENEMY_LOCKEDON_BODY_STYLE = 112;
    int SENSE_ENEMY_LOCKEDON_BORDER_STYLE = 6;
    int SENSE_ENEMY_LOCKEDON_BORDER_WIDTH = 32;
    ...
    void loadVariables(std::string key, std::string val) {
        ...
        FEATURE_NORECOIL_ON = (key.compare("FEATURE_SPECTATOR_ON") != 0) ? FEATURE_SPECTATOR_ON : toBool(val);
        FEATURE_NORECOIL_ON = (key.compare("FEATURE_SUPER_GLIDE_ON") != 0) ? FEATURE_SUPER_GLIDE_ON : toBool(val);
        //norecoil        
